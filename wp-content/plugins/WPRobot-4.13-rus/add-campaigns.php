...
<form method="post" id="wpr_new">
	...
	<div style="width:25%;float:right;";>
		...
		<div class="expld">	
			...
			<br/>{keyword}<br/>{catlink}<br/>{amazonlist:x}<br/><a href="https://linkonym.appspot.com/?http://wprobot.net/documentation/#631"><?php _e("Random Tags","wprobot") ?></a><br/><a href="https://linkonym.appspot.com/?http://wprobot.net/documentation/#63"><b><?php _e("See Documentation","wprobot") ?></b></a>
		</div>		
		...
		<div class="expld">	
			...
			<br/>{keyword}<br/><a href="https://linkonym.appspot.com/?http://wprobot.net/documentation/#631"><?php _e("Random Tags","wprobot") ?></a><br/><a href="https://linkonym.appspot.com/?http://wprobot.net/documentation/#63"><b><?php _e("See Documentation","wprobot") ?></b></a>
		</div>		
		<?php } ?>
	...
	<div id="stepbystep" class="expld" style="display:none;">
		<?php _e('<p>There are several <a href="https://linkonym.appspot.com/?http://wprobot.net/videos/"><strong>campaign creation video tutorials</strong></a> available. Be sure to watch them if you have problems!</p>
	...
	<table class="addt" width="100%">
		...
		<tr>
			...
			<!--Tooltip--><a class="tooltip" target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/documentation/#634">?<span><?php _e('This custom field will be added to every post. Premium templates often use custom fields to populate thumbnails but there are many other possible uses as well.<br/><br/><b>Click here to see a list of all available Value Tags</b><br/><br/><strong>Use the "+" button to add an additional custom field.</strong>',"wprobot") ?></span></a><br/>
