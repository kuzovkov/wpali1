...
<?php
	foreach($wpr_modules as $module) {
		if(!in_array($module, $wpr_loadedmodules)) { // not installed
			?>
			<p><input name="disable_<?php echo $module ?>" type="checkbox" id="disable_<?php echo $module ?>" value="1" disabled /> <strong><label for="disable_<?php echo $module ?>"><?php echo ucwords($module) ?> Module</label></strong> - <?php _e("not installed","wprobot") ?>, <a target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/order/ordercustom.php"><?php _e("order now!","wprobot") ?></a></p>
			<?php
		} else {
...
<?php } elseif($_GET["which"] == "del") { ?>
	...
	<div class="updated" style="margin-top: 20px;">	
		...
		<p><?php _e('You can set up an Unix cron job in your servers control panel as an alternative to the Wordpress pseodo-cron jobs. See the <a href="https://linkonym.appspot.com/?http://wprobot.net/documentation/#94a">documentation</a> for setup instructions and advanced options.',"wprobot") ?>
		<br/><br/>
...
<?php } else { ?>
	<div style="width:27%;float:right;";>
		...
		<div class="expld">
			...
			<?php _e('Have <a href="https://linkonym.appspot.com/?http://wprobot.net/documentation/#8">a look at the <b>documentation</b></a> to view an explanation of all available settings.',"wprobot") ?>
		</div>			
		...
		<div class="expld">
			...
			<?php _e('- <a target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/">WP Robot</a><br/>- <a target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/videos">Video Tutorials</a><br/>- <a target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/documentation">Online Documentation</a><br/>- <a target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/forum">Support Forum</a><br/>- <a target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/robotpal/sendnew.php">New Download Link</a>',"wprobot") ?>
		</div>			
		...
		<div class="expld">
			...
			<li><a rel="nofollow" target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/go/thebestspinner">TheBestSpinner</a></li>
			<li><a rel="nofollow" target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/go/spinnerchief">Spinnerchief</a></li>
			<li><a rel="nofollow" target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/go/chimprewriter">ChimpRewriter</a></li>
			<li><a rel="nofollow" target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/go/spinrewriter">SpinRewriter</a></li>
			<li><a rel="nofollow" target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/go/wordai">WordAI</a></li>
			<li><a rel="nofollow" target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/go/contentprofessor">ContentProfessor</a></li>
			</ul>
		...
		<div class="expld">
			...
			<ul style="list-style-type: disc; padding-left: 30px;">
			<li><a rel="nofollow" target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/go/articlebuilder">Article Builder</a></li>
			<li><a rel="nofollow" target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/go/bigcontentsearch">Big Content Search</a></li>
			</ul>
		...
		<div class="expld">
			...
			<?php _e('<a href="https://linkonym.appspot.com/?http://cmscommander.com/"><b>CMS Commander</b></a> allows you to manage and update WP Robot on all your weblogs at the same time. <a href="https://linkonym.appspot.com/?http://cmscommander.com/"><b>Try it for free now!</b></a>',"wprobot") ?>
	...
	<h3 style="text-transform:uppercase;border-bottom: 1px solid #ccc;"><?php _e("General Options","wprobot") ?></h3>	
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 		
			...
			<tr valign="top"> 
				...
				<!--Tooltip--><a class="tooltip" target="_blank" href="https://linkonym.appspot.com/?http://wprobot.net/blog/how-to-set-up-wp-robot-link-cloaking/">?<span><?php _e('<b>Important:</b> Additional steps are required to enable link cloaking. If you only check this box and don\'t finish the setup your links will not work!<br/><br/><b>Click to view setup instructions.</b>',"wprobot") ?></span></a>	
				</td> 
			</tr>				
			<tr valign="top"> 
