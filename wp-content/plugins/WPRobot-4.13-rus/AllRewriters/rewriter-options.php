...
$ar_optionsarray = array(
	"spinnerchief" => array(
		"enabled" => 0,
		"link" => "https://linkonym.appspot.com/?http://wprobot.net/go/spinnerchief",
		"name" => "SpinnerChief",
	...
	"thebestspinner" => array(
		"enabled" => 0,
		"link" => "https://linkonym.appspot.com/?http://wprobot.net/go/thebestspinner",
		"name" => "TheBestSpinner",
	...
	"spinchimp" => array(
		"enabled" => 0,
		"link" => "https://linkonym.appspot.com/?http://wprobot.net/go/chimprewriter",
		"name" => "ChimpRewriter",
	...
	"spinrewriter" => array(
		"enabled" => 0,
		"link" => "https://linkonym.appspot.com/?http://wprobot.net/go/spinrewriter",
		"name" => "SpinRewriter",
	...
	"wordai" => array(
		"enabled" => 0,
		"link" => "https://linkonym.appspot.com/?http://wprobot.net/go/wordai",
		"name" => "WordAI",
	...
	"contentprofessor" => array(
		"enabled" => 0,
		"link" => "https://linkonym.appspot.com/?http://wprobot.net/go/contentprofessor",
