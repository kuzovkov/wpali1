...
<body id="link" onload="tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';" style="display: none">
	...
	<div class="panel_wrapper" style="overflow:auto;height:165px;">
		...
		<p>"Start" marks the number of the returned results that will be used, "Num" the number of results inserted. See the <a href="https://linkonym.appspot.com/?http://wprobot.net/documentation/#64" target="_blank">documentation</a> for details.</p>
        </div>	
