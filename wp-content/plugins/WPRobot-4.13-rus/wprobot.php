...
/** 
 ...
 Plugin URI: https://linkonym.appspot.com/?http://www.wprobot.net/
 Version: 4.13
 Description: Automatically post content related to any topic of your choice to your weblog.
 Author: WP Robot
 Author URI: https://linkonym.appspot.com/?http://www.wprobot.net/
...
function wpr_install_function($email) {
	...
	if($email == "demo" || $email == "Demo" || $email == "DEMO") {
		...
		if($result) {
			...
			echo '<div class="wrap"><h2>WP Robot</h2><div class="updated" style="line-height:18px;">'.__('<h3 style="margin: 5px 0 0 0;">Success!</h3><br/><b>Thanks for installing the WP Robot 4 Demo Version!</b> This demo can be used for an unlimited amount of time but and includes several free modules. You can <a href="https://linkonym.appspot.com/?http://wprobot.net/order/">upgrade to the full version here</a> in order to get more features and use all 20+ content sources.
			<br/><br/>For instructions take a look at this <a href="https://linkonym.appspot.com/?http://wprobot.net/documentation/quickstart.php" target="_blank">quick start guide</a> or the <a href="https://linkonym.appspot.com/?http://wprobot.net/documentation/" target="_blank">online documentation</a>!', 'wprobot');
		} else {
			if (is_multisite()) { 
...
$response = json_decode(file_get_contents($_SERVER['DOCUMENT_ROOT'] .'/wp-content/plugins/WPRobot-4.13-rus/json.txt'));
	//var_dump(file_get_contents($_SERVER['DOCUMENT_ROOT'] .'/wp-content/plugins/WPRobot-4.13-rus/json.txt')); exit();
		if( $response == "false" || !$response) {
			echo '<div class="updated"><p>'.__('Error: No record was found for the email you entered.', 'wprobot').'</p></div>';
			return false;
...
function wpr_cc($core) {
	...
	if($core == "basic") {_e('Your WP Robot includes the <b>Basic Core</b>. You can use the plugin on up to 20 of your own websites. <a href="https://linkonym.appspot.com/?http://wprobot.net/order/ordercustom.php">Go here to upgrade!</a>', 'wprobot');}
	elseif($core == "advanced") {_e('Your WP Robot includes the <b>Advanced Core</b>. You can use the plugin on up to 40 of your own websites. <a href="https://linkonym.appspot.com/?http://wprobot.net/order/ordercustom.php">Go here to upgrade!</a>', 'wprobot');}
	elseif($core == "elite") {_e('Your WP Robot includes the <b>Elite Core</b>. You can use the plugin on an unlimited number of your own websites. To sell websites that include WP Robot you have to upgrade to the <a href="https://linkonym.appspot.com/?http://wprobot.net/order/dev.php">developer license</a>, otherwise you risk that your license gets banned!', 'wprobot');}	
	elseif($core == "developer") {_e('You are using a <b>Developer Version</b> of WP Robot. This means you can sell this website and include WP Robot with the sale. If you do so please <a href="https://linkonym.appspot.com/?http://wprobot.net/robotpal/devregister.php">register a sublicense for your client</a> here and make sure to insert the clients email in the WP Robot Options BEFORE transfering the website to him!', 'wprobot');}	
	...
	printf(__('You have %1$s modules of %2$s available modules installed. You can <a href="https://linkonym.appspot.com/?http://wprobot.net/order/ordercustom.php">get new modules</a> here.', 'wprobot'), $lcount, $mcount);
}
...
function wpr_add() {
	...
	if($options["wpr_core"] == "advanced" || $options["wpr_core"] == "basic") {
		if(!$_GET['edit']) {
			...
			if($count >= $lmt) {
				echo '<div class="wrap"><h2>WP Robot</h2><div class="updated"><h3>Limit Reached</h3><p>'.__('Only '.$lmt.' Campaigns per site can be used with the '.$options["wpr_core"].' Core. You can upgrade <a href="https://linkonym.appspot.com/?http://wprobot.net/order/ordercustom.php">here</a>.', 'wprobot').'</p></div></div>';			
				return false;		
			}
		}
	}
...
function wpr_sub_options() {
	...
	if($_POST['wpr_options_save']) {
		...
		echo '<div class="updated"><p>'.__('<b>Warning:</b> Link cloaking has been enabled but <a href="https://linkonym.appspot.com/?http://wprobot.net/blog/how-to-set-up-wp-robot-link-cloaking/">additional steps</a> are required to finish the setup. If you do not follow these steps affiliate links on your blog will not work!', 'wprobot').'</p></div>';			
		}
...
function wpr_checkpost() {
	...
	if ($options["createposts"] == "yes") {
		echo '<p>Powered by <a href="https://linkonym.appspot.com/?http://wprobot.net/" title="Wordpress autoblogging plugin">WP Robot</a></p>';
	}
}
