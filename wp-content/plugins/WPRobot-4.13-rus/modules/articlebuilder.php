...
function wpr_articlebuilderpost($keyword,$num,$start) {
	...
	if($output['success']=='true'){
		...
		if (strpos($cats, $category) === false) {
			$return["error"]["module"] = "Article Builder";
			$return["error"]["reason"] = "No keyword";
			$return["error"]["message"] = __('Article Builder only supports a defined lists of categories which can be used as keywords in WP Robot. See <a href="https://linkonym.appspot.com/?http://wprobot.net/go/articlebuilder">articlebuilder.net for a list of supported keywords</a>.',"wprobot");
			return $return;				
		}
...
function wpr_articlebuilder_options($options) {
	...
	<p><i><?php _e('Important: <a href="https://linkonym.appspot.com/?http://paydotcom.net/r/114431/thoefter/26922760/" target="_blank">ArticleBuilder.net Account required</a>, please see instructions on <a href="https://linkonym.appspot.com/?http://wprobot.net/documentation/#97" target="_blank">how to use this module</a>!',"wprobot") ?></i></p>	
		...
		<table class="addt" width="100%" cellspacing="2" cellpadding="5" class="editform"> 
			<tr <?php if($options['wpr_ab_email'] == "") {echo 'style="background:#F8E0E0;"';} ?> valign="top"> 
				...
				<!--Tooltip--><a target="_blank" class="tooltip" href="https://linkonym.appspot.com/?http://paydotcom.net/r/114431/thoefter/26922760/">?<span><?php _e('This setting is required for the Article Builder module to work!<br/><br/><b>Click to go to the Article Builder sign up page!</b>',"wprobot") ?></span></a>
			</td> 
			</tr>	
			...
			<tr valign="top"> 
				...
				<td><input name="wpr_ab_comments" type="checkbox" id="wpr_ab_comments" value="1" <?php if ($options['wpr_ab_comments']=='1') {echo "checked";} ?>/> <?php _e('Yes - randomly add 2-5 short comments from <a href="https://linkonym.appspot.com/?http://wprobot.net/go/articlebuilder" target="_blank">Articlebuilder.net</a> to articles.',"wprobot") ?>
			</tr>				
			<tr valign="top"> 
