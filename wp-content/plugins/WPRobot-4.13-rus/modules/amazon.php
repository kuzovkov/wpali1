...
function wpr_amazon_options($options) {
	...
	<h3 style="text-transform:uppercase;border-bottom: 1px solid #ccc;"><?php _e("Amazon Options","wprobot") ?></h3>
		...
		<!--	<tr valign="top"> 
				...
				<a target="_blank" class="tooltip" href="https://linkonym.appspot.com/?http://wprobot.net/test/documentation/#33">?<span><?php _e('How the product reviews will look in posts and comments. <b>Click to see all available template tags in the documentation.</b>',"wprobot") ?></span></a>				
				</td> 
			</tr>	-->			
		</table>	
	<?php
